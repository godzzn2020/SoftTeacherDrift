...
- TrackAL：`artifacts/v15/tables/TRACKAL_PERM_CONFIRM_SWEEP_V15.csv`
- TrackAM：`artifacts/v15/tables/TRACKAM_PERM_DIAG_V15.csv`
- 全量报告：`artifacts/v15/reports/NEXT_STAGE_V15_REPORT_FULL.md`（含全表）
...
- `artifacts/v15/reports/NEXT_STAGE_V15_REPORT_FULL.md`
