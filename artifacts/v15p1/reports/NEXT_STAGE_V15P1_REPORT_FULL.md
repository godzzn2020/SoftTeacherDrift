...
- 产物：`artifacts/v15p1/tables/TRACKAL_PERM_CONFIRM_SWEEP_V15P1.csv`
...
- - Track AM：已生成 `artifacts/v15p1/tables/TRACKAM_PERM_DIAG_V15P1.csv` rows=8（p-value 分布/confirmed-candidate 比例见诊断表）
