...
- 产物：`artifacts/v15p3/tables/TRACKAL_PERM_CONFIRM_STABILITY_V15P3.csv`
...
- - Track AM：已生成 `artifacts/v15p3/tables/TRACKAM_PERM_DIAG_V15P3.csv` rows=10（含 stagger_abrupt3；p-value 分布/confirmed-candidate 比例见诊断表）
