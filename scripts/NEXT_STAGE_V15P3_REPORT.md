...
- TrackAL：`scripts/TRACKAL_PERM_CONFIRM_STABILITY_V15P3.csv`
- TrackAM：`scripts/TRACKAM_PERM_DIAG_V15P3.csv`
- 全量报告：`scripts/NEXT_STAGE_V15P3_REPORT_FULL.md`（含全表）
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| P_perm_vote_score_a0.03_pre500_post10_n5 | vote_score | 0.03 | 500 | 10 | True | 0.000 | 0.000 | 258.2 | 179.2 | 26.210 | 374.5 | 0.7624 |
| P_perm_vote_score_a0.03_pre500_post10_n5_side2s | vote_score | 0.03 | 500 | 10 | True | 0.000 | 0.000 | 263.6 | 214.7 | 26.300 | 370.9 | 0.7624 |
| P_perm_vote_score_a0.02_pre500_post10_n5_side2s | vote_score | 0.02 | 500 | 10 | True | 0.000 | 0.000 | 262.7 | 222.4 | 26.450 | 368.3 | 0.7671 |
| P_perm_vote_score_a0.02_pre500_post10_n5 | vote_score | 0.02 | 500 | 10 | True | 0.000 | 0.000 | 267.3 | 239.5 | 26.470 | 366.3 | 0.7647 |
| P_perm_vote_score_a0.025_pre500_post10_n5 | vote_score | 0.025 | 500 | 10 | True | 0.000 | 0.000 | 267.0 | 241.7 | 26.520 | 365.7 | 0.7631 |
| A_weighted_n5 | N/A | N/A | N/A | N/A | True | 0.000 | 0.000 | 242.7 | 242.0 | 26.780 | 371.9 | 0.7676 |

## 产物
- `scripts/NEXT_STAGE_V15P3_REPORT.md`
- `scripts/NEXT_STAGE_V15P3_REPORT_FULL.md`
