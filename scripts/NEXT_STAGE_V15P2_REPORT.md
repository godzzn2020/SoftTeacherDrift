...
- TrackAL：`scripts/TRACKAL_PERM_CONFIRM_STABILITY_V15P2.csv`
- TrackAM：`scripts/TRACKAM_PERM_DIAG_V15P2.csv`
- 全量报告：`scripts/NEXT_STAGE_V15P2_REPORT_FULL.md`（含全表）
...
## 产物
- `scripts/NEXT_STAGE_V15P2_REPORT.md`
- `scripts/NEXT_STAGE_V15P2_REPORT_FULL.md`
